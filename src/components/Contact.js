  ...
  return (
    <section className='my-28' id='contact'>
      <header className='px-5 text-2xl font-bold pt-10'>
        <h2>Contact Me</h2>
        <p className='text-base font-thin'>I would be glad to hear your thoughts</p>
      </header>
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Frédéric Vulliet</p>
            <p className='font-thin'>Fillière, Haute-Savoie, France</p>
            <a href='mailto: f.vulliet@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              f.vulliet@gmail.com
            </a>
          </div>
          <a className='border-b-2 mt-3 inline-block border-gray-500' href='./CV Frédéric Vulliet 2021' target='_blank' rel='noreferrer'>
            Resume/CV
          </a>
          <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/frédéric-vulliet-82823565' target='_blank' rel='noreferrer'>
